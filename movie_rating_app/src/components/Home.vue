      ...
      <v-card>
        <v-card-title primary-title>
          ...
          <span class="grey--text">
            2016 - Science fiction film/Action fiction - 3h 3m
          </span>
        </v-card-title>
        <v-card-text>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">
              2017 - Drama/Science fiction film - 2h 21m
            </span>
          </div>
        </v-card-title>
        <v-card-text>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">
              2017 - Fantasy/Science fiction film - 2h 35m
            </span>
          </div>
        </v-card-title>
        <v-card-text>
...
export default {
  ...
  methods: {
    reply () {
      this.message = 'I am doing great, thank you!';
    }
  }
}
</script>
